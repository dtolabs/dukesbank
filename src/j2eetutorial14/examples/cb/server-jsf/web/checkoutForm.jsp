...
<f:loadBundle basename="com.sun.cb.messages.CBMessages" var="CBMessages"/>
<f:view>
...
<h:panelGrid  columns="5" headerClass="list-header" rowClasses="list-row"
        styleClass="list-background" title="CheckOut Form" >
        ...
        <h:inputText id="lastName" value="#{checkoutFormBean.lastName}" 
            size="15" maxlength="20" required="true" />
        ...
        <h:inputText id="areaCode" value="#{checkoutFormBean.areaCode}" size="3" 
             maxlength="3" required="true"/>
        <h:inputText id="phoneNumber" value="#{checkoutFormBean.phoneNumber}"  
        ...
        <h:inputText id="city" value="#{checkoutFormBean.city}" 
        ...
        <h:inputText id="state" value="#{checkoutFormBean.state}" size="2" 
        ...
        <h:inputText id="zip" value="#{checkoutFormBean.zip}" size="5" 
        ...
        <h:inputText id="CCNumber" value="#{checkoutFormBean.CCNumber}" size="16" 
