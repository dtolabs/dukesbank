    ...
    static final Object[][] contents =
        {
...

            {
                ...
                "Su cesta de compras contiene " + "{0,choice,0#ning" +
                "\u00fa" + "n articulo|1#un articulo|1< {0} articulos}"
            },
            

            {
                "Newsletters",
                "Suscripci" + "\u00f3" + "n gratuita a nuestro bolet" +
                "\u00ed" + "n:"
            },
            ...
            {
                "CustomerInfo",
                "Incorpore su informaci" + "\u00f3" + "n en la forma."
            },
            {
                "BookCatalog",
