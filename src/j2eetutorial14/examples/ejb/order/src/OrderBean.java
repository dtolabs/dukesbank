...
public class OrderBean implements EntityBean {
    private static final String dbName = "java:comp/env/jdbc/OrderDB";
    ...
    private boolean selectByPrimaryKey(String primaryKey)
        ...
        String selectStatement =
            "select orderid " + "from bmp_orders where orderid = ? ";
    ...
    private void deleteOrder(String orderId) throws SQLException {
        ...
        String deleteStatement =
            "delete from bmp_orders  " + "where orderid = ?";
        PreparedStatement prepStmt = con.prepareStatement(deleteStatement);
    ...
    private void storeOrder() throws SQLException {
        ...
        String updateStatement =
            "update bmp_orders set customerid =  ? ," +
