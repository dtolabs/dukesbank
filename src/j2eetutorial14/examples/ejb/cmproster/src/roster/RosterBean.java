...
public class RosterBean implements SessionBean {
        ...
        try {
            LocalPlayer player =
                playerHome.create(details.getId(), details.getName(),
                    details.getPosition(), details.getSalary());
        } catch (Exception ex) {
            throw new EJBException(ex.getMessage());
        }
    }
    ...
    public PlayerDetails getPlayer(String playerId) {
        ...
        try {
            ...
            playerDetails = new PlayerDetails(playerId, player.getName(),
    ...
    public void createTeamInLeague(TeamDetails details, String leagueId) {
        ...
        try {
            LocalLeague league = leagueHome.findByPrimaryKey(leagueId);
            LocalTeam team =
                teamHome.create(details.getId(), details.getName(),
                    details.getCity());
    ...
    public LeagueDetails getLeague(String leagueId) {
        ...
        try {
            ...
            leagueDetails = new LeagueDetails(leagueId, league.getName(),
                    league.getSport());
        } catch (Exception ex) {
            throw new EJBException(ex.getMessage());
        }
